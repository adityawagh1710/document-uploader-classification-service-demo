...
{{- define "ingestion-subgraph.labels" -}}
...
{{- define "ingestion-subgraph.selector" -}}
app: ingestion-subgraph
{{- end -}}

{{/* Target namespace (required). */}}
{{- define "ingestion-subgraph.namespace" -}}
{{- required "values.namespace.name is required" .Values.namespace.name -}}
{{- end -}}

{{/* ServiceAccount name. */}}
{{- define "ingestion-subgraph.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- default "ingestion-subgraph" .Values.serviceAccount.name -}}
{{- else -}}
...
{{- define "ingestion-subgraph.image" -}}
