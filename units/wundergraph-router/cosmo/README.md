...
- **ingestion subgraph** — our Go **gqlgen Federation v2** server (`cmd/wundergraph-router`),
...
BACKEND=memory PORT=8099 go run ./cmd/wundergraph-router       # or BACKEND=aws + LocalStack
